...
df = pd.read_csv('end_end_400K_ours.csv')
#df = pd.read_csv('Rg_all_topologies.csv')

df2 = pd.read_csv('Alber_end_end.csv')
...
box_plot = plt.boxplot(all_values, vert=True, positions=[1, 2, 3], widths=0.6, patch_artist=True, showmeans=True, meanline=True, meanprops=dict(linewidth=2, color='green'), boxprops=dict(facecolor='red', edgecolor='black'))
...
plt.xticks([1, 2, 3], ['this work', 'Li 2017', 'Ulianov 2021'], fontsize=22)
...
plt.ylabel('End-to-End distance chr X ($\mu$m)', fontsize=22)
